#!/usr/bin/env python3
"""
CLI entrypoint for sovereign-diagnostic-tree
"""
import sys
import json
import argparse
...
def main():
    parser = argparse.ArgumentParser(description="Deterministic fault-tree diagnostic engine paired with conversational LLM guidance. Guides field technicians through complex industrial machinery repairs via interactive decision trees, validating electrical voltages and pressure deltas.")
